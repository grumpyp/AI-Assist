...
def patrick():
    ...
    #             voicemail_left=False, transcript_requested=False, status="in progress")
    # db.session.add(call)
    # db.session.commit()
    # print(Call.query.all())
